...
另外，音位用双斜杠包裹，音素则用方括号包裹。音位大部分选取最常用的那个变体表示。
...
##### 短元音`/ɒ/`和长元音`/ɔː/`
/ɒ/是短短的、嘴巴张开更大的“喔”，/ɔː/是嘴巴张开、舌头更往后、更长的“喔——”。
...
双元音由一个短元音和一个极短的单元音组合而成。在分析上，双元音被看作一个音素而非两个音素。另外，所有双元音的发音时长在规定上都是相同的。这些双元音分别是：
